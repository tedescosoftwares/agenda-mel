...
export const ICONE_AVISO = {
  ...
  pedido_enviado: Hourglass, fechar_dia: ClipboardCheck, veio: ClipboardCheck, contestacao: MessageSquareWarning, troca_vencida: CalendarX, parte_recusada: TriangleAlert, visita_em_espera: Users, promocao_pendente: BadgePercent, promocao_aprovada: BadgePercent, promocao_recusada: BadgePercent, avaliar_atendimento: Star, pagamento_confirmado: Wallet, reserva_expirada: TriangleAlert, estorno_a_caminho: Wallet, sinal_retido: Wallet, estorno_sem_saldo: TriangleAlert, estorno_atrasado: Hourglass, sinal_em_credito: Wallet, credito_vencido: Wallet, teste: Bell, teste_push: Bell,
}
