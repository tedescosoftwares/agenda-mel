import { CalendarCheck, CircleCheck, CircleX, AlarmClock, Zap, Heart, Star, Gift, TriangleAlert, CalendarDays, Repeat, Megaphone, Bell, MessageCircle, Wallet, Hourglass, ClipboardCheck, MessageSquareWarning, CalendarX, Users } from 'lucide-react'
...
export const ICONE_AVISO = {
  ...
  pedido_enviado: Hourglass, fechar_dia: ClipboardCheck, veio: ClipboardCheck, contestacao: MessageSquareWarning, troca_vencida: CalendarX, parte_recusada: TriangleAlert, visita_em_espera: Users, teste: Bell, teste_push: Bell,
}
