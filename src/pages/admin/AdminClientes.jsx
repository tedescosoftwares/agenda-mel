          ...
          {filtradas.map((c) => (
            <div key={c.client_id} className="card cliente-row cliente-row-vinculo">
              ...
              <div className="cliente-info">
                ...
                <FichaCliente atendimentos={c.atendimentos} faltas={c.faltas} cancelamentos={c.cancelamentos} tardios={c.cancelamentos_tardios} remarcacoes={c.remarcacoes} compacta />
