...
--         diagnóstico do bot
--    038  o horário só vale depois que a profissional aceita: o bot
--         cria um PEDIDO, ela responde 1 ou 2 pelo WhatsApp (ou pela
--         tela), e cada uma configura o próprio prazo e o que
--         acontece se ele passar
--    039  o pedido sai na hora, não pela fila: prazo de 2h esperando
--         alguém escoar a fila expira antes de ela ver. E confirmar
--         pela agenda passa a fechar o pedido
--    040  BLOCO A: quem age pela tela não recebe mensagem do que
--         acabou de fazer, e quem precisa saber passa a ser avisado.
--         A cliente finalmente fica sabendo quando a profissional
--         cancela. Telefone de fora do Brasil deixa de ser rejeitado
--    041  o aceite passa a valer para quem marca pelo app também, e
--         não só pela conversa. Um lugar só decide: o gatilho do
--         insert
--    042  o mesmo celular escrito de duas formas deixa de ser duas
--         pessoas: na Argentina o WhatsApp manda ora com o 9 depois
--         do 54, ora sem. Guardar o número e comparar telefones
--         passam a ser perguntas diferentes
--    043  o bot montava a resposta e ela não saía: para saber por onde
--         responder, o sistema exigia já ter conseguido enviar algo
--         antes. Quem escreve pela primeira vez nunca tem isso. Passa
--         a responder pelo número que RECEBEU a mensagem
--    044  a janela de silêncio (21h-8h) segurava até a resposta que a
--         cliente estava esperando: a Mel aceitava às 22h55 e a cliente
--         só saberia às 8h. Fato que muda o dia dela sai na hora;
--         lembrete e convite esperam amanhecer
--    045  envio que morre no meio devolve a mensagem para a fila: uma
--         linha marcada 'enviando' por uma execução que não terminou
--         não saía de lá nunca, e não aparecia como problema
--    046  bancada de testes: ensaiar a conversa inteira pelo admin, sem
--         precisar de um segundo telefone. Roda o caminho de verdade e
--         só o último centímetro é fingido — as mensagens que iriam
--         para o WhatsApp ficam para você ler
--    047  agendamento 'pendente' sem pedido nenhum: quando a DONA
--         marcava pela agenda para uma profissional com aceite ligado,
--         o gatilho não abria pedido nem confirmava. Ficava pendurado
--         para sempre, e a cliente esperando um aviso que ninguém ia
--         mandar. Achado pela bancada, no primeiro uso
--    048  a página pública passa a usar a mesma conta de horário livre
--         que o bot usa. Havia duas: a do navegador ignorava os
--         bloqueios da profissional, então o site oferecia horário em
--         cima do almoço dela
--    049  favoritas, avaliações (só de atendimento concluído da própria
--         cliente) e a posição na fila de espera — as três camadas que
--         o desenho do MIMO pede e o banco não tinha
--
...
insert into public.migracoes_aplicadas (arquivo) values ('020_numeros.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('021_dados_teste_historico.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('022_gatilhos.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('023_whatsapp.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('024_resposta_whatsapp.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('025_botoes.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('026_botao_so_na_oficial.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('027_estilo_do_botao.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('028_primeiro_voto_vale.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('029_texto_bonito.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('030_porteiro_da_ia.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('031_truncate_nao.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('032_avisa_a_profissional.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('033_ia_entende_o_resto.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('034_pedido_nao_cai_no_vazio.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('035_bot_que_marca.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('036_cliente_ganha_o_telefone.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('037_sem_cadastro_nao_some.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 038_aceite_da_profissional.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('038_aceite_da_profissional.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 039_o_pedido_sai_na_hora.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('039_o_pedido_sai_na_hora.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('082_categorias.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('083_promocoes.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 084_promocao_com_desconto.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('084_promocao_com_desconto.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 085_pagina_do_salao.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('085_pagina_do_salao.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 086_destaques_e_aprovacao.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('086_destaques_e_aprovacao.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 087_capas_de_categoria.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('087_capas_de_categoria.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 088_capas_em_carrossel_e_preferida.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('088_capas_em_carrossel_e_preferida.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 089_convite_para_avaliar.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('089_convite_para_avaliar.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 090_pagamento_pelo_app.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('090_pagamento_pelo_app.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 091_delete_com_where.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('093_estorno_com_saldo.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 094_politica_de_cancelamento.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('094_politica_de_cancelamento.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 095_pago_e_confirmado.sql
-- =============================================================
...
-- =============================================================
-- >>> 097_concluir_na_hora_e_destaques.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('097_concluir_na_hora_e_destaques.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 098_destaque_so_com_quem_faz.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('098_destaque_so_com_quem_faz.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 099_quem_saiu_nao_ve.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('099_quem_saiu_nao_ve.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('100_localizacao.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('101_parceria.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('102_pdv.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 103_mover_horario.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('103_mover_horario.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 104_pdv_no_tempo.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('104_pdv_no_tempo.sql') on conflict (arquivo) do nothing;
