...
insert into public.migracoes_aplicadas (arquivo) values ('107_quadro_sabe_a_cliente.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 108_comanda_do_dia.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('108_comanda_do_dia.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('109_repasse.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 110_avaliacao_no_balcao.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('110_avaliacao_no_balcao.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 111_aceite_da_casa.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('111_aceite_da_casa.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 112_avaliacoes_e_projecao.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('112_avaliacoes_e_projecao.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 113_cota_da_casa.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('113_cota_da_casa.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('114_onboarding.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 115_cadastro_e_onboarding.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('115_cadastro_e_onboarding.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 116_seo_e_conteudo.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('116_seo_e_conteudo.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 117_leads_e_paginas_por_problema.sql
-- =============================================================
...
insert into public.migracoes_aplicadas (arquivo) values ('117_leads_e_paginas_por_problema.sql') on conflict (arquivo) do nothing;
...
insert into public.migracoes_aplicadas (arquivo) values ('118_plano.sql') on conflict (arquivo) do nothing;

-- =============================================================
-- >>> 119_equipe_configurada.sql
-- =============================================================
